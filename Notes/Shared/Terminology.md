...
- ***MAC Address*** - (Media Access Control) each computer connected to a a network has it to determine where data is supported to be send and while transferring photos trough network for example.
